...
typeof jQuery === 'undefined' &&
  ...
  (function(t) {
    ...
    t.extend(t.easing, {
      ...
      easeInExpo(t) {
        return t === 0 ? 0 : i(2, 10 * t - 10);
      },
      easeOutExpo(t) {
        return t === 1 ? 1 : 1 - i(2, -10 * t);
      },
      easeInOutExpo(t) {
        return t === 0
          ? 0
          : t === 1
            ? 1
            : t < 0.5 ? i(2, 20 * t - 10) / 2 : (2 - i(2, -20 * t + 10)) / 2;
      },
      easeInCirc(t) {
        return 1 - n(1 - i(t, 2));
      },
      ...
      easeInElastic(t) {
        return t === 0
          ? 0
          : t === 1 ? 1 : -i(2, 10 * t - 10) * o((10 * t - 10.75) * c);
      },
      easeOutElastic(t) {
        return t === 0
          ? 0
          : t === 1 ? 1 : i(2, -10 * t) * o((10 * t - 0.75) * c) + 1;
      },
      easeInOutElastic(t) {
        return t === 0
          ? 0
        ...
        if (!t.jQuery) {
          ...
          (i.isWindow = function(t) {
            ...
            (i.isPlainObject = function(t) {
              let e;
              if (!t || i.type(t) !== 'object' || t.nodeType || i.isWindow(t))
                return !1;
              try {
                if (
                  t.constructor &&
            ...
            (i.extend = function() {
              ...
              for (
                typeof s === 'boolean' &&
                  ((u = s), (s = arguments[l] || {}), l++),
                  typeof s !== 'object' && i.type(s) !== 'function' && (s = {}),
                  l === c && ((s = this), l--);
                c > l;
                l++
              )
      ...
      (function(t) {
        ...
        (function(t, e, i, n) {
          ...
          function l(t, i, n, o) {
            ...
            function d() {
              for (let e = 0; b > e; ++e) C[e] = l(e * w, t, n);
            }
            function p(e, i, o) {
              let a,
                r,
            ...
            function h(e) {
              for (var i = 0, o = 1, a = b - 1; o != a && C[o] <= e; ++o)
                i += w;
              let r = i + (e - C[--o]) / (C[o + 1] - C[o]) * w,
                s = c(r, t, n);
              return s >= m ? u(e, r) : s == 0 ? r : p(e, i, i + w);
            }
            function f() {
              (T = !0), (t != i || n != o) && d();
            }
            ...
            var C = k ? new Float32Array(b) : new Array(b),
              ...
              S = function(e) {
                return (
                  ...
                  t === i && n === o
                    ? e
                    : e === 0 ? 0 : e === 1 ? 1 : l(h(e), i, o)
                );
              };
            S.getControlPoints = function() {
              return [{ x: t, y: i }, { x: n, y: o }];
            };
            const P = `generateBezier(${[t, i, n, o]})`;
            return (
              (S.toString = function() {
                return P;
              }),
          ...
          function c(t, e) {
            ...
            return (
              v.isString(t)
                ? b.Easings[t] || (i = !1)
                : (i =
                    v.isArray(t) && t.length === 1
                      ? s(...t)
                      : v.isArray(t) && t.length === 2
                        ? w(...t.concat([e]))
                        : !(!v.isArray(t) || t.length !== 4) && l(...t)),
              !1 === i &&
                      ...
                      for (const A in x)
                        if (A !== 'element') {
                          ...
                          if (g === 1) O = E.endValue;
                            ...
                            const M = E.endValue - E.startValue;
                            if (
                          ...
                          if (((E.currentValue = O), A === 'tween')) m = O;
                          else {
                            ...
                            const q = k.setPropertyValue(
                              T,
                              A,
                              E.currentValue +
                                (parseFloat(O) === 0 ? '' : E.unitType),
                              E.rootPropertyValue,
                              E.scrollData,
                            );
          ...
          function d(t, e) {
            ...
            for (
              ...
              if (
                ...
                var h = !1;
                p.each(k.Lists.transforms3D, (t, e) => {
              ...
              s && !0 !== a.loop && s(o),
                r(d) &&
                  !0 === a.loop &&
                  !e &&
                  (p.each(r(d).tweensContainer, (t, e) => {
                    /^rotate/.test(t) &&
            ...
            b.State.calls[t] = !1;
            for (let f = 0, v = b.State.calls.length; v > f; f++)
            ...
            v = {
              ...
              isNodeList(t) {
                return (
                  ...
                  t.length !== n &&
                  (t.length === 0 ||
                    (typeof t[0] === 'object' && t[0].nodeType > 0))
                );
              },
              isWrapped(t) {
              ...
              var k = (b.CSS = {
                  ...
                  register() {
                    ...
                    if (h)
                      for (e in k.Hooks.templates) {
                        ...
                        const o = i[1].match(k.RegEx.valueSplit);
                        n[0] === 'Color' &&
                          (n.push(n.shift()),
                          o.push(o.shift()),
                ...
                Normalizations: {
                  ...
                  register() {
                    ...
                    for (t = 0; t < k.Lists.transformsBase.length; t++)
                      !(function() {
                        const e = k.Lists.transformsBase[t];
                    ...
                    for (
                      ...
                      if (
                        ((o =
                          i === 0
                            ? t
                            : e[i] + t.replace(/^\w/, t => t.toUpperCase())),
                ...
                Values: {
                  hexToRgb(t) {
                    ...
                    return (
                      (t = t.replace(i, (t, e, i, n) => e + e + i + i + n + n)),
                      (e = n.exec(t)),
                      e
                        ? [
                            parseInt(e[1], 16),
                ...
                getPropertyValue(t, i, o, a) {
                  function s(t, i) {
                    ...
                    if (h <= 8) l = p.css(t, i);
                      ...
                      if (
                        (/^(width|height)$/.test(i) &&
                          k.getPropertyValue(t, 'display') === 0 &&
                          ((c = !0),
                          k.setPropertyValue(
                            t,
                            'display',
                      ...
                      (f =
                        r(t) === n
                          ...
                          : r(t).computedStyle
                            ? r(t).computedStyle
                            : (r(t).computedStyle = e.getComputedStyle(
                                t,
                                null,
                              ))),
                        i === 'borderColor' && (i = 'borderTopColor'),
                        ((l =
                          h === 9 && i === 'filter'
                    ...
                    if (l === 'auto' && /^(top|right|bottom|left)$/i.test(i)) {
                      const v = s(t, 'position');
                      (v === 'fixed' ||
                        (v === 'absolute' && /top|left/i.test(i))) &&
                        (l = `${p(t).position()[i]}px`);
                    }
                    return l;
                  }
                ...
                setPropertyValue(t, i, n, o, a) {
                  ...
                  if (i === 'scroll')
                    ...
                    k.Normalizations.registered[i] &&
                    k.Normalizations.registered[i]('name', t) === 'transform'
                  )
                  ...
                  return (
                    ...
                    p.each(t, (t, a) => {
                      if ((r(a) === n && b.init(a), i === n))
                        ...
                        const s = b.CSS.setPropertyValue(a, e, i);
                        s[0] === 'transform' && b.CSS.flushTransformCache(a),
                          (o = s);
                      }
                    }),
                    o
              ...
              var x = function() {
                ...
                function o() {
                  function t(t) {
                    ...
                    if (A === 'scroll') {
                      ...
                      s.container
                        ...
                        : ((g =
                          ...
                          (w =
                            b.State.scrollAnchor[
                              b.State[
                                `scrollProperty${S === 'Left' ? 'Top' : 'Left'}`
                              ]
                            ]),
                      ...
                      r(a).opts.display === 'none' &&
                        (r(a).opts.display = 'auto'),
                        r(a).opts.visibility === 'hidden' &&
                      ...
                      for (let q in m) {
                        ...
                        if (
                          ...
                          (l[q] = {
                            ...
                            b.debug &&
                              console.log(
                                `tweensContainer (${q}): ${JSON.stringify(
                                  l[q],
                                )}`,
                                a,
                              );
                          ...
                          b.debug &&
                            console.log(
                              `Skipping [${j}] due to a lack of browser support.`,
                            );
                      }
                      l.element = a;
                    }
                  ...
                  !1 !== b.mock &&
                    ...
                    !1 === s.queue
                      ? s.delay ? setTimeout(t, s.delay) : t()
                      : p.queue(
                          a,
                          s.queue,
                          (e, i) =>
                ...
                if (
                  ...
                  if (!/^(stop|finish)$/i.test(m) && !p.isPlainObject(y)) {
                    y = {};
                    for (let S = h + 1; S < arguments.length; S++)
                  ...
                  switch (m) {
                    ...
                    default:
                      if (!p.isPlainObject(m) || v.isEmptyObject(m)) {
                        ...
                        const M = `Velocity: First argument (${m}) was not a property map, a known action, or a registered redirect. Aborting.`;
                        return (
                  ...
                  if (
                    ...
                    for (let V = 0; q > V; V++) {
                      const H = { delay: z.delay, progress: z.progress };
                      V === q - 1 &&
                        ((H.display = z.display),
                ...
                p.each(['Down', 'Up'], (t, e) => {
                  b.Redirects[`slide${e}`] = function(t, i, o, a, r, s) {
                    ...
                    l.display === n &&
                      (l.display =
                        e === 'Down'
                          ? b.CSS.Values.getDisplayType(t) === 'inline'
                            ? 'inline-block'
                            : 'block'
                          : 'none'),
                      (l.begin = function() {
                        ...
                        for (const i in d) {
                          h[i] = t.style[i];
                          const n = b.CSS.getPropertyValue(t, i);
                          d[i] = e === 'Down' ? [n, 0] : [0, n];
                        }
  ...
  (function(t, e, i, n) {
    ...
    function s(t, e, i) {
      for (let o = Object.keys(e), a = 0; a < o.length; )
    ...
    function M(t) {
      const e = t.length;
      if (e === 1) return { x: dt(t[0].clientX), y: dt(t[0].clientY) };
    ...
    function F(t, e) {
      ...
      let o,
        ...
        s = [],
        l = this.target;
      if (((a = i.filter(t => v(t.target, l))), e === xt))
    ...
    function rt(t, e) {
      const i = t.element;
      r(t.options.cssProps, (t, n) => {
        i.style[k(i.style, n)] = e ? t : '';
      });
    }
    function st(t, i) {
      const n = e.createEvent('Event');
    ...
    c(L, T, {
      handler(t) {
        let e = Vt[t.type];
        e & xt && t.button === 0 && (this.pressed = !0),
          e & Ct && t.which !== 1 && (e = Tt),
          this.pressed &&
            this.allow &&
            (e & Tt && (this.pressed = !1),
    ...
    (Y.prototype = {
      ...
      c(K, Z, {
        ...
        emit(t) {
          if ((this._super.emit.call(this, t), t.scale !== 1)) {
      ...
      c(it, Z, {
        ...
        attrTest(t) {
          ...
          return (
            i & (Mt | It)
              ? (e = t.velocity)
              : i & Mt ? (e = t.velocityX) : i & It && (e = t.velocityY),
            this._super.attrTest.call(this, t) &&
              i & t.direction &&
      ...
      c(nt, Y, {
        ...
        process(t) {
          let e = this.options,
            ...
            n = t.distance < e.threshold,
            a = t.deltaTime < e.time;
          if ((this.reset(), t.eventType & xt && this.count === 0))
            return this.failTimeout();
          if (n && a && i) {
            if (t.eventType != Tt) return this.failTimeout();
            let r = !this.pTime || t.timeStamp - this.pTime < e.interval,
    ...
    (at.prototype = {
      ...
      recognize(t) {
        ...
        if (!e.stopped) {
          ...
          for (let a = 0; a < n.length; )
            (i = n[a]),
              e.stopped === 2 || (o && i != o && !i.canRecognizeWith(o))
                ? i.reset()
                : i.recognize(t),
      ...
      emit(t, e) {
        ...
        const i = this.handlers[t] && this.handlers[t].slice();
        if (i && i.length) {
          (e.type = t),
  ...
  (Materialize.elementOrParentIsFixed = function(t) {
    ...
    return (
      e.add(e.parents()).each(function() {
        if ($(this).css('position') === 'fixed') return (i = !0), !1;
      }),
      i
    );
  });
...
(Vel = jQuery ? jQuery.Velocity : $ ? $.Velocity : Velocity),
        ...
        this.each(function() {
          ...
          function r(t, i) {
            i || t.toggleClass('active'),
              e.accordion || h === 'accordion' || void 0 === h ? n(t) : a(t),
              s(t);
          }
          function s(t) {
            t.hasClass('active')
          ...
          if (o !== 'destroy')
            if (i >= 0 && i < p.length) {
              const f = p.eq(i);
              f.length &&
                (o === 'open' || (o === 'close' && f.hasClass('active'))) &&
                r(f);
            } else
              u(),
                d.on('click.collapse', '> li > .collapsible-header', e => {
                  let i = t(e.target);
                  l(i) && (i = c(i)), r(i);
                }),
                e.accordion || h === 'accordion' || void 0 === h
            ...
            : void this.each(function() {
                ...
                function o(e) {
                  e === 'focus' && (l = !0),
                    ...
                    c.addClass('active'),
                    r.addClass('active');
                  const i = r[0].getBoundingClientRect().width;
                  !0 === s.constrainWidth
                    ? c.css('width', i)
                  ...
                  h === 'left'
                    ...
                    : h === 'right' &&
                      ...
                      (v =
                        r.position().left + i - c.width() + (f = -s.gutter))),
                    c.css({
                      position: 'absolute',
                    ...
                    setTimeout(() => {
                      t(document).on(`click.${c.attr('id')}`, e => {
                ...
                if ((n(), r.after(c), s.hover)) {
                  ...
                  r.off(`click.${r.attr('id')}`),
                    ...
                    r.on('mouseleave', e => {
                      const i = e.toElement || e.relatedTarget;
                      t(i)
                  ...
                  r.off(`click.${r.attr('id')}`),
                    r.on(`click.${r.attr('id')}`, e => {
                      l ||
                        (r[0] != e.currentTarget ||
                        r.hasClass('active') ||
                        t(e.target).closest('.dropdown-content').length !== 0
                          ? r.hasClass('active') &&
                            (a(), t(document).off(`click.${c.attr('id')}`))
                          : (e.preventDefault(),
          ...
          _createClass(
            ...
            [
              ...
              },
              {
                ...
                value(e) {
                  const i = t(e.target).closest('.modal-trigger');
                  if (e.target && i.length) {
                    let n = i[0].getAttribute('href');
                    n = n ? n.slice(1) : i[0].getAttribute('data-target');
                    const o = document.getElementById(n).M_Modal;
              ...
              },
              {
                ...
                value(e) {
                  const i = t(e.target).closest('.modal-close');
              ...
              },
              {
                key: 'handleKeydown',
                value(t) {
                  t.keyCode === 27 && this.options.dismissible && this.close();
                },
              },
              {
                key: 'animateIn',
                value() {
                  ...
                  const n = {
                    ...
                    ease: 'easeOutCubic',
                    complete() {
                      typeof i.options.ready === 'function' &&
                  ...
                  const i = {
                    ...
                    complete() {
                      (t.$el[0].style.display = 'none'),
                        typeof t.options.complete === 'function' &&
  ...
  (function(t) {
    (t.fn.materialbox = function() {
      return this.each(function() {
        function e() {
          a = !1;
          let e = s.parent('.material-placeholder'),
          ...
          s.wrap(l),
            s.on('click', () => {
              ...
              s
                ...
                .data('width', u)
                .data('height', d);
              const h = t('<div id="materialbox-overlay"></div>')
                .css({ opacity: 0 })
                .click(() => {
                  !0 === a && e();
                });
              s.before(h);
              const f = h[0].getBoundingClientRect();
              if (
                (h.css({
                  width: l,
                  height: c,
                ...
                const v = t('<div class="materialbox-caption"></div>');
              ...
              u / l > d / c
                ...
                t(window).on('scroll.materialbox', () => {
                  o && e();
                }),
                t(window).on('resize.materialbox', () => {
                  o && e();
                }),
                t(document).on('keyup.materialbox', t => {
                  t.keyCode === 27 && !0 === a && o && e();
                });
            });
        }
      });
  ...
  (function(t) {
    const e = {
      init(e) {
        const i = { onShow: null, swipeable: !1, responsiveThreshold: 1 / 0 };
        e = t.extend(i, e);
        const n = Materialize.objectSelectorString(t(this));
        return this.each(function(i) {
          let o,
            a,
            r,
          ...
          e.swipeable && d > e.responsiveThreshold && (e.swipeable = !1),
            (o = t(p.filter(`[href="${location.hash}"]`))).length === 0 &&
              (o = t(this)
            ...
            e.swipeable
              ? (p.each(function() {
                  const e = t(Materialize.escapeHash(this.hash));
  ...
  (function(t) {
    t.fn.tooltip = function(i) {
      const n = { delay: 350, tooltip: '', position: 'bottom', html: !1 };
      return i === 'remove'
        ? (this.each(function() {
        ...
        : ((i = t.extend(n, i)),
          this.each(function() {
            ...
            d();
            (c = (function() {
              const e = t('<div class="material-tooltip"></div>');
              return (
                (l = a
                  ? t('<span></span>').html(l)
                  : t('<span></span>').text(l)),
    ...
    function a(t) {
      ...
      for (
        ...
        if (
          ...
          i.className.indexOf('waves-effect') !== -1
        ) {
          e = i;
          break;
        }
    ...
    var s = s || {},
      ...
      c = {
        ...
        show(t, e) {
          ...
          const d = { top: `${s}px`, left: `${l}px` };
          (a.className += ' waves-notransition'),
        ...
        hide(t) {
          ...
          let a = (i = n[n.length - 1]).getAttribute('data-x'),
      ...
      u = {
        ...
        allowEvent(t) {
          ...
          return (
            t.type === 'touchstart'
              ? (u.touches += 1)
              : t.type === 'touchend' || t.type === 'touchcancel'
                ? setTimeout(() => {
                    u.touches > 0 && (u.touches -= 1);
                  }, 500)
                : t.type === 'mousedown' && u.touches > 0 && (e = !1),
            e
          );
        },
        touchup(t) {
        ...
        function n(e, i, o, a) {
          if ((_classCallCheck(this, n), e)) {
            (this.options = {
              ...
              n._toasts.length === 0 && n._createContainer(),
              n._toasts.push(this);
            const r = this.createToast();
            (r.M_Toast = this),
              (this.el = r),
              this._animateIn(),
              this.setTimer();
          ...
          _createClass(
                  ...
                  this.wasSwiped &&
                    ...
                    e(
                      ...
                      { opacity: 0, marginTop: '-40px' },
                      {
                        ...
                        queue: !1,
                        complete() {
                          typeof t.options.completeCallback === 'function' &&
                            t.options.completeCallback(),
                            t.el.parentNode.removeChild(t.el),
                            n._toasts.splice(n._toasts.indexOf(t), 1),
                            n._toasts.length === 0 && n._removeContainer();
                        },
                      },
                    );
                },
            ...
            [
              ...
              },
              {
                ...
                value(e) {
                  if (e.target && t(e.target).closest('.toast').length) {
                    const i = t(e.target).closest('.toast')[0].M_Toast;
                    (i.panning = !0),
                      (n._draggedToast = i),
              ...
              },
              {
                key: 'removeAll',
                value() {
                  for (const t in n._toasts) n._toasts[t].remove();
                },
              },
              {
                key: 'defaults',
    ...
    const e = {
        ...
        (e = t.extend(i, e)),
          t(this).each(function() {
            let i = t(this),
              ...
              o = t(`#${n}`);
            e.menuWidth != 300 && o.css('width', e.menuWidth);
            let a = t(`.drag-target[data-sidenav="${n}"]`);
            e.draggable
              ? (a.length && a.remove(),
              ...
              !0 === e.closeOnClick &&
                o.on('click.itemclick', 'a:not(.collapsible-header)', () => {
      ...
      destroy() {
        let e = t('#sidenav-overlay'),
          i = t(
            `.drag-target[data-sidenav="${t(this).attr('data-activates')}"]`,
          );
  ...
  (function(t) {
    ...
    function i(i) {
      ...
      t.each(d, (t, e) => {
        typeof e.data('scrollSpy:ticks') !== 'number' &&
          e.triggerHandler('scrollSpy:enter'),
          e.data('scrollSpy:ticks', l);
      }),
        t.each(r, (t, e) => {
          const i = e.data('scrollSpy:ticks');
          typeof i === 'number' &&
            i !== l &&
    ...
    (t.scrollSpy = function(e, n) {
      ...
      (e = t(e)).each((e, i) => {
        a.push(t(i)),
          ...
          t(`a[href="#${t(i).attr('id')}"]`).click(function(e) {
            e.preventDefault();
            const i = t(Materialize.escapeHash(this.hash)).offset().top + 1;
            t('html, body').animate(
      ...
      return (
        ...
        e.on('scrollSpy:exit', function() {
          if ((l = t.grep(l, t => t.height() != 0))[0]) {
            t(n.getActiveElement(l[0].attr('id'))).removeClass(n.activeClass);
            const e = t(this);
            (l = t.grep(l, t => t.attr('id') != e.attr('id')))[0] &&
              t(n.getActiveElement(l[0].attr('id'))).addClass(n.activeClass);
          }
        }),
        e
  ...
  (function(t) {
    t(document).ready(() => {
      ...
      t(document).on('change', i, function() {
        ...
        t(document).on('reset', e => {
          ...
          n.is('form') &&
            ...
            n.find('select.initialized').each(() => {
              const t = n.find('option[selected]').text();
      ...
      let o = 'input[type=range]',
        a = !1;
      t(o).each(function() {
        const e = t('<span class="thumb"><span class="value"></span></span>');
        t(this).after(e);
      });
      let r = function(t) {
          const e = `${-7 + parseInt(t.parent().css('padding-left'))}px`;
          t.velocity(
          ...
          return (
            ...
            this.each(function() {
              ...
              if (t.isEmptyObject(o))
                ...
                n.off('blur.autocomplete').on('blur.autocomplete', () => {
                  p();
                }),
                  n
                    .off('keyup.autocomplete focus.autocomplete')
                    .on('keyup.autocomplete focus.autocomplete', r => {
                      a = 0;
                      const s = n.val().toLowerCase();
                      if (r.which !== 13 && r.which !== 38 && r.which !== 40) {
                        if (i !== s && (p(), s.length >= e.minLength))
                          for (const l in o)
                            if (
                              o.hasOwnProperty(l) &&
                              l.toLowerCase().indexOf(s) !== -1
                            ) {
                              if (a >= e.limit) break;
                              const d = t('<li></li>');
                              o[l]
                                ? d.append(
                                    `<img src="${
                                      o[l]
                                    }" class="right circle"><span>${l}</span>`,
                                  )
                    ...
                    .on(
                      ...
                      function() {
                        ...
                        n.val(i),
                          n.trigger('change'),
                          p(),
                          typeof e.onAutocomplete === 'function' &&
      ...
      (t.fn.material_select = function(e) {
        ...
        t(this).each(function() {
          ...
          if (!n.hasClass('browser-default')) {
            ...
            const r = Materialize.guid();
            n.attr('data-select-id', r);
            const s = t('<div class="select-wrapper"></div>');
            s.addClass(n.attr('class')),
              n.is(':disabled') && s.addClass('disabled');
            let l = t(
                `<ul id="select-options-${r}" class="dropdown-content select-dropdown ${
              ...
              h = function(e, i, n) {
                ...
                if (c) {
                  ...
                  return (
                    ...
                    l.append(
                      t(
                        `<li class="${a}${r}"><img alt="" src="${c}"${d}><span>${s}${i.html()}</span></li>`,
                      ),
                    ),
                    !0
                  );
                ...
                l.append(
                  t(`<li class="${a}${r}"><span>${s}${i.html()}</span></li>`),
                );
              };
            c.length &&
              c.each(function() {
                if (t(this).is('option'))
                  ...
                  const e = t(this).children('option');
                  l.append(
                    t(
                      `<li class="optgroup"><span>${t(this).attr(
                        'label',
                      )}</span></li>`,
                    ),
                  ),
            ...
            var f = t('<span class="caret">&#9660;</span>'),
              ...
              m = t(
                ...
                } data-activates="select-options-${r}" value="${v}"/>`,
              );
            n.before(m),
              m.before(f),
              m.after(l),
              ...
              m.on({
                focus() {
                  if (
                    ...
                    const i = l.find('li').filter(function() {
                      return (
                        t(this)
                          .text()
              ...
              if (e.which != 9)
                if (e.which != 40 || l.is(':visible')) {
                  if (e.which != 13 || l.is(':visible')) {
                    e.preventDefault();
                    let i = String.fromCharCode(e.which).toLowerCase(),
                      n = [9, 13, 27, 38, 40];
                    ...
                    if (e.which == 13) {
                      const s = l.find('li.selected:not(.disabled)')[0];
          ...
          this.each(function() {
            ...
            u != -1 && (o = c.eq(u)),
              ...
              e.indicators &&
                ...
                c.each(i => {
                  const o = t('<li class="indicator-item"></li>');
                  o.click(function() {
                    n(
                      l
                        .parent()
            ...
            s
              ...
              .on('pan', t => {
                if (t.gesture.pointerType === 'touch') {
                  ...
                  let a;
                  p &&
                    ((a = $curr_slide.next()).length === 0 && (a = c.first()),
                    a.velocity(
                      { opacity: 1 },
                      { duration: 300, queue: !1, easing: 'easeOutQuad' },
                    )),
                    h &&
                      ((a = $curr_slide.prev()).length === 0 && (a = c.last()),
                      a.velocity(
                        { opacity: 1 },
                        { duration: 300, queue: !1, easing: 'easeOutQuad' },
                      ));
    ...
    t(document).ready(() => {
      t(document).on('click.card', '.card', function(e) {
        if (t(this).find('> .card-reveal').length) {
          const i = t(e.target).closest('.card');
        ...
        (n.hasAutocomplete = !t.isEmptyObject(o.autocompleteOptions.data)),
          ...
          (this.handleEvents = function() {
            ...
            n.$document
              ...
              .on('click.chips-focus', e.CHIPS, i => {
                t(i.target)
                  .find(e.INPUT)
                  .focus();
              }),
              n.$document
                ...
                .on('click.chips-select', e.CHIP, i => {
                  const o = t(i.target);
                  if (o.length) {
              ...
              n.$document
                ...
                .on('focusin.chips', `${e.CHIPS} ${e.INPUT}`, i => {
                  const n = t(i.target).closest(e.CHIPS);
                  n.addClass('focus'),
              ...
              n.$document
                ...
                .on('focusout.chips', `${e.CHIPS} ${e.INPUT}`, i => {
                  const n = t(i.target).closest(e.CHIPS);
                  n.removeClass('focus'),
              ...
              n.$document
                ...
                .on('keydown.chips-add', `${e.CHIPS} ${e.INPUT}`, i => {
                  let o = t(i.target),
                    a = o.closest(e.CHIPS),
              ...
              n.$document
                ...
                .on('click.chips-delete', `${e.CHIPS} ${e.DELETE}`, i => {
                  let o = t(i.target),
                    a = o.closest(e.CHIPS),
                    r = o.closest(e.CHIP);
                  i.stopPropagation(),
  ...
  (function(t) {
    t.fn.pushpin = function(e) {
      const i = { top: 0, bottom: 1 / 0, offset: 0 };
      return e === 'remove'
        ? (this.each(function() {
          ...
          this.each(function() {
            ...
            t(this).data('pushpin-id', o),
              ...
              t(window).on(`scroll.${o}`, () => {
                const i = t(window).scrollTop() + e.offset;
                n(a, i);
              });
          }));
    };
              ...
              e.css({
                ...
                setTimeout(() => {
                  e.css({ overflow: 'hidden', 'background-color': p }),
                    ...
                    t(window).on('scroll.fabToolbarClose', () => {
                      o(e),
                        t(window).off('scroll.fabToolbarClose'),
                        t(document).off('click.fabToolbarClose');
                    }),
                    t(document).on('click.fabToolbarClose', i => {
            ...
            .on('pan', function(n) {
              if (n.gesture.pointerType === 'touch') {
                ...
                o.velocity(
                  ...
                  a === 4 && (r > o.innerWidth() / 2 || s < -0.75) && (e = !0),
                  a === 2 &&
  ...
  (function(t) {
    ...
    Materialize.scrollFire = function(t) {
      let i = function() {
          for (
            let e = window.pageYOffset + window.innerHeight, i = 0;
            i < t.length;
            i++
          ) {
            let n = t[i],
            ...
            s !== null &&
              ...
              (typeof r === 'function'
                ? r.call(this, s)
                : typeof r === 'string' && new Function(r)(s),
              (n.done = !0));
          }
        },
        n = Materialize.throttle(() => {
          i();
        }, t.throttle || 100);
      e ||
  ...
  (function(t) {
    ...
    function e(a, s, u, d) {
      ...
      function v() {
        ...
        !0 === w.hiddenName
          ...
          : (e =
              (e = [
                typeof w.hiddenPrefix === 'string' ? w.hiddenPrefix : '',
                typeof w.hiddenSuffix === 'string' ? w.hiddenSuffix : '_submit',
              ])[0] +
              a.name +
              e[1]),
          (T._hidden = t(
      ...
      function m(t) {
        let e = t.keyCode,
          i = /^(8|46)$/.test(e);
        if (e == 27) return T.close(), !1;
        (e == 32 || i || (!b.open && T.component.key[e])) &&
          (t.preventDefault(),
          t.stopPropagation(),
      ...
      function g(t) {
        t.stopPropagation(),
          t.type == 'focus' && T.$root.addClass(k.focused),
          T.open();
      }
      if (!a) return e;
      var y = !1,
        ...
        T = (C.prototype = {
          ...
          get(t, i) {
            if (((t = t || 'value'), b[t] != null)) return b[t];
            if (t == 'valueSubmit') {
    ...
    function n() {
      ...
      let e = t('<div style="visibility:hidden;width:100px" />').appendTo(
          'body',
        ),
        i = e[0].offsetWidth;
      e.css('overflow', 'scroll');
      const n = t('<div style="width:100%" />').appendTo(e)[0].offsetWidth;
      return e.remove(), i - n;
    }
    function o(e, i, n) {
      if (t.isPlainObject(i)) for (const o in i) a(e, o, i[o]);
      else a(e, i, n);
    }
    function a(t, e, i) {
      t.setAttribute((e == 'role' ? '' : 'aria-') + e, i);
    }
    function r() {
      try {
    ...
    return (
      ...
      (e._ = {
        ...
        trigger(t, e, i) {
          return typeof t === 'function' ? t.apply(e, i || []) : t;
        },
        digits(t) {
  ...
  (function(t) {
    ...
    (i.prototype.set = function(t, e, i) {
      let n = this,
        o = n.item;
      return e === null
        ? (t == 'clear' && (t = 'select'), (o[t] = e), n)
        : ((o[t == 'enable' ? 'disable' : t == 'flip' ? 'enable' : t] = n.queue[
            t
          ]
            .split(' ')
            .map(o => (e = n[o](t, e, i)))
      ...
      (i.prototype.validate = function(t, i, o) {
        let a,
          ...
          v =
            p &&
            c.item.disable.filter(t => {
              if (e.isArray(t)) {
                const o = c.create(t).pick;
      ...
      (i.prototype.parse = function(t, e, i) {
        ...
        return e && typeof e === 'string'
          ? ((i && i.format) || ((i = i || {}).format = o.settings.format),
            o.formats.toArray(i.format).map(t => {
              let i = o.formats[t],
      ...
      (i.prototype.formats = (function() {
        ...
        return {
          ...
          mmm(e, i) {
            const n = this.settings.monthsShort;
            return e ? t(e, n, i) : n[i.month];
          },
          mmmm(e, i) {
            const n = this.settings.monthsFull;
            return e ? t(e, n, i) : n[i.month];
          },
          yy(t, e) {
          ...
          toString(t, e) {
            ...
            return i.formats
              .toArray(t)
              .map(
                t => n.trigger(i.formats[t], i, [0, e]) || t.replace(/^!/, ''),
              )
              .join('');
          },
        };
        ...
        return (n.isInteger(t) && n.isInteger(i)) ||
          ...
          : (n.isDate(t) || e.isArray(t)) && (n.isDate(i) || e.isArray(i))
            ...
            : !(!e.isPlainObject(t) || !e.isPlainObject(i)) &&
              (o.isDateExact(t.from, i.from) && o.isDateExact(t.to, i.to));
      }),
      ...
      (i.prototype.nodes = function(t) {
        let e = this,
          ...
          f = function(o) {
            let a = i.showMonthsShort ? i.monthsShort : i.monthsFull;
            return (
              o == 'short_months' && (a = i.monthsShort),
              i.selectMonths && void 0 == o
                ? n.node(
                    ...
                    `${t ? '' : 'disabled'} ${n.ariaAttr({
                      controls: `${e.$node[0].id}_table`,
                    })} title="${i.labelMonthSelect}"`,
                  )
                : o == 'short_months'
                  ? r != null ? a[r.month] : a[l.month]
        ...
        return (
          (createDayLabel = function() {
            return r != null ? r.date : a.date;
          }),
          (createWeekdayLabel = function() {
            let t;
            return (t = r != null ? r.day : a.day), i.weekdaysShort[t];
          }),
          n.node(
            'div',
              ...
              n.node(
                ...
                n.node(
                  ...
                  n.node(
                      ...
                      n.node(
                        ...
                        n.group({
                          ...
                          item(t) {
                            const o =
                              i.firstDay &&
                              e.create([l.year, l.month, 1]).day === 0
                                ? -7
                                : 0;
                            return [
                              n.group({
                    ...
                    i.klass.table,
                    `id="${e.$node[0].id}_table" ${n.ariaAttr({
                      role: 'grid',
  ...
  (function(t) {
    ...
    function o(o, r) {
      ...
      if (
        (d.on(p, e => {
          t(e.target).closest('.clockpicker-tick').length === 0 && l(e, !0);
        }),
        c)
      ) {
    ...
    (o.DEFAULTS = {
      ...
      (o.prototype.show = function(e) {
        if (!this.isShown) {
          ...
          if (
            ...
            const c = document.querySelector(this.options.container);
                ...
                (this.amOrPm === 'PM'
                  ...
                  : (this.spanAmPm
                    ...
                    this.spanAmPm
                      .children('#click-pm')
                      .removeClass('text-primary'))),
              r.on(`resize.clockpicker${this.id}`, () => {
                n.isShown && n.locate();
              }),
              (this.isAppended = !0);
          }
          this.toggleView('hours'),
            ...
            s.on(
              ...
              e => {
                const i = t(e.target);
                i.closest(n.popover.find('.picker__wrap')).length === 0 &&
                  i.closest(n.input).length === 0 &&
                  n.hide();
              },
            ),
            s.on(`keyup.clockpicker.${this.id}`, t => {
              t.keyCode === 27 && n.hide();
            }),
      ...
      (o.prototype.toggleView = function(e, i) {
        let n = !1;
        e === 'minutes' &&
          t(this.hoursView).css('visibility') === 'visible' &&
      ...
      (o.prototype.setHand = function(e, n, o, a) {
        ...
        if (
          ...
          (s = r * u),
          p.twelvehour
            ? l ? r === 0 && (r = 12) : (o && (r *= 5), r === 60 && (r = 0))
            : l
              ? (r === 12 && (r = 0),
                (r = h ? (r === 0 ? 12 : r) : r === 0 ? 0 : r + 12))
              : (o && (r *= 5), r === 60 && (r = 0)),
      ...
      (t.fn.pickatime = function(e) {
        ...
        return this.each(function() {
          ...
          if (a) typeof a[e] === 'function' && a[e](...i);
          else {
            const r = t.extend(
              {},
              o.DEFAULTS,
  ...
  (function(t) {
    ...
    function i(e) {
      let i = e.parent().find('span[class="character-counter"]');
      i.length ||
        ((i = t('<span/>')
  ...
  (function(t) {
    const e = {
      init(e) {
        ...
        return this.each(function(i) {
          ...
          function s(i) {
            ...
            for (
              (!W || (w >= 0 && w < C)) &&
                ...
                t(c).hasClass('active') ||
                  ...
                  t(c).addClass('active')),
                (c.style[_] = `${u} translateX(${-a / 2}px) translateX(${s *
                  e.shift *
                  l *
                  n}px) translateZ(${e.dist * l}px)`),
                (c.style.zIndex = 0),
                e.fullWidth
                  ? (tweenedOpacity = 1)
              ...
              e.fullWidth
                ...
                (!W || w + n < C) &&
                  (((c = v[r(w + n)]).style[_] = `${u} translateX(${e.shift +
                    (x * n - a) / 2}px) translateZ(${zTranslation}px)`),
                  (c.style.zIndex = -n),
                  (c.style.opacity = tweenedOpacity),
                  (c.style.display = 'block')),
                e.fullWidth
            ...
            if (
              ((!W || (w >= 0 && w < C)) &&
                (((c = v[r(w)]).style[_] = `${u} translateX(${-a /
                  2}px) translateX(${s * e.shift * l}px) translateZ(${e.dist *
                  l}px)`),
                (c.style.zIndex = 0),
                e.fullWidth
                  ? (tweenedOpacity = 1)
                ...
                (c.style.opacity = tweenedOpacity),
                (c.style.display = 'block')),
              d !== w && typeof e.onCycleTo === 'function')
            ) {
              var f = j.find('.carousel-item').eq(r(w));
              e.onCycleTo.call(this, f, q);
            }
            typeof L === 'function' && (L.call(this, f, q), (L = null));
          }
          function l() {
            let t, e, i;
            (e = (t = Date.now()) - I),
          ...
          function u(i) {
            ...
            if (!e.fullWidth) {
              const n = t(i.target)
                ...
                .index();
              r(w) - n !== 0 && (i.preventDefault(), i.stopPropagation()), d(n);
            }
          }
          function d(t) {
            let e = w % C - t;
          ...
          const Q = function(e) {
            let i = j.find('.carousel-item.active').length
          ...
          j.addClass('initialized'),
            ...
            j.find('.carousel-item').each(function(e) {
              if ((v.push(t(this)[0]), N)) {
                const i = t('<li class="indicator-item"></li>');
                e === 0 && i.addClass('active'),
                  i.click(function(e) {
          ...
          t(window)
            ...
            t(this).on('carouselSet', (t, e, i) => {
              void 0 === e && (e = 0), typeof i === 'function' && (L = i), d(e);
            });
        });
      },
      next(e, i) {
      ...
      destroy() {
        const e = t(this).attr('data-namespace');
  ...
  (function(t) {
      ...
      init(e) {
        return this.each(function() {
          ...
          let l = function() {
            ...
            c = function() {
              let e = i.css('position') === 'fixed';
              if (!e)
                for (
                  let r = i.parents(), l = 0;
                  l < r.length && !(e = t(r[l]).css('position') == 'fixed');
                  l++
                );
              let c = i.outerWidth(),
                u = i.outerHeight(),
          ...
          e == 'open' &&
            ...
            o.is('.open') ||
              (o.addClass('open'),
              setTimeout(() => {
                r.off('click.tapTarget').on('click.tapTarget', t => {
                  l(), r.off('click.tapTarget');
                }),
                  t(document)
                    .off('click.tapTarget')
                    .on('click.tapTarget', e => {
                      l(), t(document).off('click.tapTarget');
                    });
                const e = Materialize.throttle(() => {
                  c();
                }, 200);
                t(window)
    ...
    t.fn.tapTarget = function(i) {
      if (e[i] || typeof i === 'object') return e.init.apply(this, arguments);
